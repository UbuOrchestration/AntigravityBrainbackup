    ...
    if (hasAllPrices) {
      ...
      html += `
        <tr>
          ...
          <td class="text-right text-gold">${sellPrice.toLocaleString()} GP</td>
          <td class="text-right text-red">${tax.toLocaleString()} GP</td>
          <td class="text-right ${profitClass} text-bold">${netProfit.toLocaleString()} GP</td>
          <td class="text-right ${roiClass}">${roi.toFixed(2)}%</td>
          <td class="text-right">${limit ? limit.toLocaleString() : '--'}</td>
