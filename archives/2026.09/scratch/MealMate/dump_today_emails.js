...
async function dump() {
  ...
  for (const msg of response.messages) {
    if (msg.labels && (msg.labels.includes('inbox') || msg.labels.includes('received')) && !msg.labels.includes('sent')) {
      console.log(`\n========================================`);
      console.log(`Message ID: ${msg.message_id} | From: ${msg.from} | Time: ${msg.timestamp}`);
      ...
      if (rawInfo.download_url) {
        ...
        console.log('--- EML Content Preview ---');
        console.log(eml.slice(0, 1500));
      }
    }
  }
}
